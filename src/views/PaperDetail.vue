      ...
      <aside class="sidebar">
        ...
        <div class="sidebar-section">
          ...
          <div class="link-list">
            ...
            <a v-if="hasCodeUrl && codeInfo" :href="codeInfo.url" target="_blank" class="external-link">
              ...
              {{ codeInfo.platform === 'github' ? 'GitHub Repository' : codeInfo.platform === 'github_pages' ? 'Project Page' : 'Code Repository' }}
            </a>
          </div>
        </div>
