...
from app.routers import arxiv, bookmarks, downloads, skills, llm, graph, subagents, memory, conversation, team, pdf_annotations
...
@app.get("/")
async def root():
    return {"message": "XivMind API is running", "version": "0.5.1"}
