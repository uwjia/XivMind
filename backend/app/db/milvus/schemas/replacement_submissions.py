...
class ReplacementSubmissionsSchema(BaseCollectionSchema):
    """Schema for replacement_submissions collection."""
    ...
    def get_fields(self) -> List[FieldSchema]:
        return [
            ...
            FieldSchema(name="listing_date", dtype=DataType.VARCHAR, max_length=10),
