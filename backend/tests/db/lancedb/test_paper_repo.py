...
class TestLanceDBPaperRepositoryGetPapersByAuthor:
    @pytest.fixture
    def repo(self):
        return LanceDBPaperRepository()
    ...
    def test_get_papers_by_author_single_author(self, repo):
        ...
        mock_table.to_pandas = Mock(return_value=pd.DataFrame([{
            "id": "2301.00001",
            "title": "Paper 1",
            "abstract": "Abstract 1",
    ...
    def test_get_papers_by_author_pagination(self, repo):
        ...
        mock_table = Mock()
        mock_table.count_rows = Mock(return_value=10)
        mock_table.to_pandas = Mock(return_value=pd.DataFrame(papers_data))
